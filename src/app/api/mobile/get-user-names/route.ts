/**
 * POST /api/mobile/get-user-names
 *
 * Ensures profile entries exist for users and returns their names (mobile app endpoint)
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Get User Names Error:', errorMsg)
    return NextResponse.json(
      {
        success: false,
        error: errorMsg,
